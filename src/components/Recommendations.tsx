        ...
        {recommendations.map((rec, i) => (
          ...
          >
            <div className="flex items-start justify-between gap-2 mb-1.5">
              ...
              <span className="text-sm font-mono font-semibold text-success whitespace-nowrap">{rec.savings}</span>
            </div>
            <h3 className="text-sm font-medium text-foreground leading-snug">{rec.title}</h3>
